...
public class MetereologicServiceApplication implements CommandLineRunner {
	...
	private void addInfo()
	{
		...
		Location lo2 = new Location( new BigDecimal("23.57"), new BigDecimal("32.6"), "Bogota", "Cundinamarca");
		Location lo3 = new Location( new BigDecimal("23.54"), new BigDecimal("34.34"), "Bogota", "Cundinamarca");

		List<Location>locations = new ArrayList<>(Arrays.asList(lo1, lo2, lo3));
		locations.stream().forEach(this.locationService::save);

		MetereologicalData metereologicalData1 = new MetereologicalData(LocalDate.of(2022, 8, 26));
		MetereologicalData metereologicalData2 = new MetereologicalData(LocalDate.of(2022, 3, 12));
		MetereologicalData metereologicalData3 = new MetereologicalData(LocalDate.of(2022, 6, 5));


		List<MetereologicalData>metereologicalDatas = new ArrayList<>(Arrays.asList(metereologicalData1, metereologicalData2, metereologicalData3));
		metereologicalDatas.stream().forEach(this.metereologicalDataService::save);
